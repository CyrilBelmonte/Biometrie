...
public class HoughTransform {
    ...
    public static void main(String[] args) throws IOException {
        ArrayData inputData = getArrayDataFromImage("src\\resources\\Hough\\Cercle.png");
        int minContrast = (args.length >= 4) ? 64 : Integer.parseInt("100");
        ArrayData outputData = houghTransform(inputData, Integer.parseInt("640"), Integer.parseInt("480"), minContrast);
        writeOutputImage("src\\resources\\Hough\\Cercle2.png", outputData);
        return;
    }
}
